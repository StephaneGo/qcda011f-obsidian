...
Date: 17/06/2026
Tags: [[-Principe de conception]]

# Notes

SOLID est un **acronyme utilisé en programmation orientée objet**. Il regroupe cinq principes conçus pour écrire un code plus lisible, modulaire et maintenable. Ces principes ont été popularisés par Robert C. Martin, expert en génie logiciel.
